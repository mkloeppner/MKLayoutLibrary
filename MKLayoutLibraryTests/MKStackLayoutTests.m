...
describe(@"MKStackLayout", ^{
    ...
    it(@"should insert a margin for a view its specified", ^{
        ...
        expect(container.frame.size.width).to.equal(subview1.frame.size.width - 10.0f);
        expect(container.frame.size.height).to.equal(subview1.frame.size.height - 10.0f);
    ...
    it(@"should insert different margins for different views", ^{
        ...
        expect(container.frame.size.width).to.equal(subview1.frame.size.width - 20.0f);
        expect(container.frame.size.height).to.equal(subview1.frame.size.height - 20.0f);
        
        expect(0.0f).to.equal(subview2.frame.origin.x + 15.0f);
        expect(0.0f).to.equal(subview2.frame.origin.y + 15.0f);
        expect(container.frame.size.width).to.equal(subview2.frame.size.width - 30.0f);
        expect(container.frame.size.height).to.equal(subview2.frame.size.height - 30.0f);
